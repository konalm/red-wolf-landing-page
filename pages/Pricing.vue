  ...
  <div class="bg-gray-800 sm:py-5">
    <main>
      ...
      <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
        ...
        <p class="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-400 sm:text-xl/8">
          {{ description }}
        </p>
        ...
        <div class="mt-16 flex justify-center">
          <fieldset aria-label="Payment frequency">
            <RadioGroup v-model="frequency"
              ...
              <RadioGroupOption as="template" v-for="option in pricing.frequencies" :key="option.value" :value="option"
                v-slot="{ checked }">
          ...
          <div v-for="tier in pricing.tiers" :key="tier.id"
            ...
            <div class="flex items-center justify-between gap-x-4">
              ...
              <p v-if="tier.mostPopular"
                class="rounded-full bg-indigo-500 px-2.5 py-1 text-xs/5 font-semibold text-white">Most popular</p>
            </div>
            ...
            <p class="mt-6 flex items-baseline gap-x-1">
              ...
              <span v-if="tier.id === 'tier-university'" class="text-sm/6 font-semibold text-gray-300">
                annually
              </span>
              <span v-else class="text-sm/6 font-semibold text-gray-300">
                {{ frequency.priceSuffix }}
              </span>
            </p>

            <!-- <a :href="tier.href" :aria-describedby="tier.id"
              :class="[tier.mostPopular ? 'bg-indigo-500 text-white shadow-sm hover:bg-indigo-400 focus-visible:outline-indigo-500' : 'bg-white/10 text-white hover:bg-white/20 focus-visible:outline-white', 'mt-6 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2']">
              Buy plan
            </a> -->
...
const description = 'Invest in a high value skill and become a full fledged software engineer'
  ...
  tiers: [
    {
      ...
      features: [
        ...
        `Access to a mentor to ask any questions (Massive benefit when getting into a small community early)`, 
        'Full access to new material released weekly'
      ],
      mostPopular: true,
    },
    {
      ...
      id: 'tier-university',
      href: '#',
      price: { monthly: '~£9,000', annually: '~£9,000' },
      description: 'Traditional 3 - 4 year university degree',
      features: [
        'Degree that most employers don\'t even care about as it doesn\'t teach you how to actually code 👎 ',
      ],
      mostPopular: false,
    },
  ],
