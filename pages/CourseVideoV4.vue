...
<!--       
<main class="py-0">
  <div class="bg-black h-[calc(100vh-64px)] w-full flex items-center justify-center">
    <div class="aspect-video w-full max-w-[90%]">
      <iframe
...
<main class="py-0">
  <div class="bg-black h-[calc(100vh-64px)] w-full flex items-center justify-center" style="border: 2px solid red">
    <div class="aspect-video w-full max-w-[90%]" style="border: 2px solid green">
      <iframe
        src="https://customer-cigaee6xmg0zgxhq.cloudflarestream.com/e1905766c033f9f40fc910a8756f08f0/iframe"
        class="w-full h-full"
        allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;"
